...
# 3
def print_string_for_number(string,
                            num):  # Method that print the string it got the number of times from the number it got
    for i in range(num):
        print(string)
...
# 6
def print_in_one_row_the_seris(num1,
                               num2):  # method that print the numbers between the numbers that were given in a row
...
# 13
def index_of_the_max_value(
        string1: str):  # Method that return the index of the max value in the given list, if there is more then 2 then it will return a masega
    maxi = max(list1)
...
# 14
def grades_to_the_students(
        num):  # Method that returns a list as long as the number it gets filld with grades from the user
    list1 = []
    for i in range(num):
...
num_students = int(input("pleas enter the number of students in the class: "))  # the MAIN program
print(grades_to_the_students(num_students))
print(f"\n")
...
print(avarge_of_the_list(grades_to_the_students(num_students)))  # the main program
print(f"\n")
